...
username = os.getenv("makwanashyamal96")  # Replace the username
access_key = os.getenv("1BJJ8UAUzbnzNdkttNNaXVPG2sITjbPiGoF5ydAowcx3kZcItu")  # Replace the access key
